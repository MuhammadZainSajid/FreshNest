...
const NoConnection = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text numberOfLines={1} adjustsFontSizeToFit style={[fonts.size_32, fonts.bold]}>
							{t('title')}
			</Text>
      <Text numberOfLines={1} adjustsFontSizeToFit style={[fonts.size_40, fonts.size_16,gutters.marginTop_12]}>
							{t('subtitle')}
			</Text>
    </View>
  );
